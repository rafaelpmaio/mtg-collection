...
import { useLoadCardslistOnPageRefresh } from "state/hooks/customHooks/useLoadCardslistOnPageRefresh";
...
const SetPage = () => {
  ...
  const loadCardslistOnRefresh = useLoadCardslistOnPageRefresh()
  ...
  useEffect(() => {
    loadCardslistOnRefresh(setsList)
  }, [setsList])
